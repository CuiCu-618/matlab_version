function [coord,num] = hexahedron_xz(iel,x_coords,y_coords,z_coords,num)
% %
...
%
        ...
        coord(5:2:9,1)=pt5*(x_coords(ip)+x_coords(ip+1));
        ...
        coord(8:6:14,3)=pt5*(z_coords(is)+z_coords(is+1));
...
%
    case 20
        ...
        coord(4:4:8,1)=pt5*(x_coords(ip)+x_coords(ip+1));
        coord(16:4:20,1)=pt5*(x_coords(ip)+x_coords(ip+1));
        %
        ...
        coord(2:4:6,3)=pt5*(z_coords(is)+z_coords(is+1));
        coord(14:4:18,3)=pt5*(z_coords(is)+z_coords(is+1));
    otherwise
        fprintf("Wrong number of nodes for hexahedral element")
end
end